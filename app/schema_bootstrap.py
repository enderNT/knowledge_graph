...
def build_schema_commands(settings: Settings) -> list[str]:
    ...
    commands.extend(
        [
            ...
            "CREATE PROPERTY Claim.supporting_quote IF NOT EXISTS STRING",
            "CREATE PROPERTY Claim.created_at IF NOT EXISTS DATETIME",
            "CREATE PROPERTY PedagogicalEvidence.uid IF NOT EXISTS STRING",
            "CREATE PROPERTY PedagogicalEvidence.concept_uid IF NOT EXISTS STRING",
            "CREATE PROPERTY PedagogicalEvidence.concept_name IF NOT EXISTS STRING",
            "CREATE PROPERTY PedagogicalEvidence.episode_id IF NOT EXISTS STRING",
            "CREATE PROPERTY PedagogicalEvidence.source_claim_uid IF NOT EXISTS STRING",
            "CREATE PROPERTY PedagogicalEvidence.statement IF NOT EXISTS STRING",
            "CREATE PROPERTY PedagogicalEvidence.supporting_quote IF NOT EXISTS STRING",
            "CREATE PROPERTY PedagogicalEvidence.kind IF NOT EXISTS STRING",
            "CREATE PROPERTY PedagogicalEvidence.status IF NOT EXISTS STRING",
            "CREATE PROPERTY PedagogicalEvidence.review_notes_json IF NOT EXISTS STRING",
            "CREATE PROPERTY PedagogicalEvidence.created_at IF NOT EXISTS DATETIME",
            "CREATE PROPERTY PedagogicalEvidence.updated_at IF NOT EXISTS DATETIME",
    ...
    commands.extend(
        [
            ...
            "CREATE INDEX IF NOT EXISTS ON PedagogicalEvidence (uid) UNIQUE",
            "CREATE INDEX IF NOT EXISTS ON PedagogicalEvidence (concept_uid) NOTUNIQUE",
            "CREATE INDEX IF NOT EXISTS ON PedagogicalEvidence (episode_id) NOTUNIQUE",
            "CREATE INDEX IF NOT EXISTS ON PedagogicalEvidence (status) NOTUNIQUE",
