...
def build_schema_commands(settings: Settings) -> list[str]:
    ...
    commands.extend(
        [
            ...
            "CREATE PROPERTY UserSpacedRepetition.user_id IF NOT EXISTS STRING",
            "CREATE PROPERTY UserSpacedRepetition.concept_uid IF NOT EXISTS STRING",
            "CREATE PROPERTY UserSpacedRepetition.dimension IF NOT EXISTS STRING",
            "CREATE PROPERTY UserSpacedRepetition.repetitions IF NOT EXISTS INTEGER",
            "CREATE PROPERTY UserSpacedRepetition.ease_factor IF NOT EXISTS DOUBLE",
            "CREATE PROPERTY UserSpacedRepetition.interval_days IF NOT EXISTS INTEGER",
            "CREATE PROPERTY UserSpacedRepetition.last_reviewed_at IF NOT EXISTS DATETIME",
            "CREATE PROPERTY UserSpacedRepetition.next_review_at IF NOT EXISTS DATETIME",
            "CREATE PROPERTY UserSpacedRepetition.propagation_relief_count IF NOT EXISTS INTEGER",
            "CREATE PROPERTY UserSpacedRepetition.requires_direct_validation IF NOT EXISTS BOOLEAN",
    ...
    commands.extend(
        [
            ...
            "CREATE INDEX IF NOT EXISTS ON UserSpacedRepetition (user_id, concept_uid, dimension) UNIQUE",
            "CREATE INDEX IF NOT EXISTS ON UserSpacedRepetition (user_id) NOTUNIQUE",
            "CREATE INDEX IF NOT EXISTS ON UserSpacedRepetition (concept_uid) NOTUNIQUE",
            "CREATE INDEX IF NOT EXISTS ON UserSpacedRepetition (next_review_at) NOTUNIQUE",
